...
public:
    ...
    void sample(const Geometry& other, const std::vector<bool>& to_keep);
    void sample(const Geometry& other, const std::vector<int>& to_keep);
