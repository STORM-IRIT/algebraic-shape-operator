...
#include <PCP/Geometry/internal/plyio.h>
...
bool PLY::load(const std::string& filename, Geometry& g, bool v)
{
...
bool PLY::save(const std::string& filename, const Geometry& g, bool v, bool binary)
{
